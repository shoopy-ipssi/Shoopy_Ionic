...
export class AppComponent implements OnInit {
  ...
  ngOnInit() {
      this.getUserMenu()
      if (window.location.pathname.split('/')[1] != 'newPassword' && window.location.pathname.split('/')[2] != 'newPassword' && window.location.pathname.split('/')[1] != 'validateAccount' && window.location.pathname.split('/')[2] != 'validateAccount') { this.gv.checkUserLogged() }
